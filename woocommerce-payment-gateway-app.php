...
function init_woocommerce_payment_gateway_app()
{
    ...
    class WooCommerce_Payment_Gateway_App extends WC_Payment_Gateway
    {
        ...
        {
            return Payment_Gateway_App_Api_Error_Context::customer_message($context, $fallback, array(
        ...
        {
            return Payment_Gateway_App_Api_Error_Context::log_context(
                Payment_Gateway_App_Api_Error_Context::parse($data),
                $extra
            );
        }
        ...
        public function process_payment($order_id)
        {
            ...
            $error_context = Payment_Gateway_App_Api_Error_Context::parse($response_body, $response_code);
            ...
            if ($response_code !== 200) {
                ...
                if ($this->debug) {
                    $this->log->error('Unexpected Response Code', Payment_Gateway_App_Api_Error_Context::log_context($error_context, array(
                        'source' => 'woocommerce-payment-gateway-app',
